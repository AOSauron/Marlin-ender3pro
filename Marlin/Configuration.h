...
#define STRING_CONFIG_H_AUTHOR "(AOSauron, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro - AOS Edition"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30.128, -0.503, -1.85 }
